...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: '/fmcakes.png',
      tags: ['React.js', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB', 'Cloudinary', 'JWT'],
      category: 'fullstack',
      demoLink: 'https://harmonious-semolina-39bb88.netlify.app/',
      codeLink: '#',
      featured: true,
      challenges: t.projects.projectsList[10].challenges,
      longDescription: t.projects.projectsList[10].longDescription,
    },
    {
      id: 12,
      ...
      tags: ['React.js', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB', 'Cloudinary', 'JWT'],
      category: 'fullstack',
      demoLink: 'https://glittery-boba-7af0c3.netlify.app/',
      codeLink: '#',
      featured: true,
      challenges: t.projects.projectsList[11].challenges,
      longDescription: t.projects.projectsList[11].longDescription,
    },
    {
      id: 13,
      ...
      tags: ['React.js', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB', 'Cloudinary', 'JWT'],
      category: 'fullstack',
      demoLink: 'https://comforting-fox-8d3087.netlify.app/',
      codeLink: '#',
      featured: true,
      challenges: t.projects.projectsList[12].challenges,
      longDescription: t.projects.projectsList[12].longDescription,
    },
    {
      id: 14,
      ...
      tags: ['React.js', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB', 'Cloudinary', 'JWT'],
      category: 'fullstack',
      demoLink: 'https://fascinating-gelato-c211a2.netlify.app/',
      codeLink: '#',
      featured: true,
      challenges: t.projects.projectsList[13].challenges,
      longDescription: t.projects.projectsList[13].longDescription,
    },
    {
      id: 1,

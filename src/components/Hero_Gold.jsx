...
const Hero = () => {
    return (
        <section id="home-section" className="relative h-screen w-screen flex items-center justify-start overflow-x-hidden bg-black">
                    ...
                    <div className="space-y-6 text-left">
                        ...
                        <div className="flex items-center gap-5 justify-start">
                            <a
                                ...
                                className="text-gray-400 hover:text-amber-400 transition-colors duration-300 hover:scale-110 transform"
                                aria-label="GitHub"
                            >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-start pt-4">
                            ...
                            <a
                                href="/CV_MABIALA-MULHO_Ibrahim.pdf"
                                download
                        ...
                        <div className="relative hidden sm:block">
                            <div className="relative bg-zinc-900 rounded-2xl border border-amber-500/20 shadow-2xl shadow-amber-500/10 overflow-hidden">
                                ...
                                <div className="bg-black border-b border-amber-500/20 px-4 py-3 flex items-center">
                                    ...
                                    <span className="ml-4 text-xs text-amber-400 font-mono">elite-code.js</span>
                                </div>
                                ...
                                <div className="p-6 font-mono text-sm space-y-1 bg-gradient-to-br from-zinc-900 to-black">
                                    <div className="text-gray-500">
                                        ...
                                        <span>// Excellence  & Expertise de Mulho MABIALA</span>
                                    </div>
                                    ...
                                    <div className="pl-8">
                                        ...
                                        <span className="text-white">: </span>
                                        <span className="text-yellow-300">'23+ réalisations'</span>
                                    </div>

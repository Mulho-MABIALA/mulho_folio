                        ...
                        <div className="relative overflow-hidden rounded-2xl">
                            ...
                            <div className="aspect-[4/5] bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center">
                                <div className="text-center p-8">
                                    <svg className="w-32 h-32 mx-auto text-zinc-700 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    <p className="text-gray-500 text-sm">Ajoutez votre photo ici</p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-2xl sm:text-3xl font-bold text-white">
                                Bonjour ! Je suis <span className="bg-gradient-to-r from-amber-400 to-yellow-600 bg-clip-text text-transparent">Mulho MABIALA</span>
                            </h3>

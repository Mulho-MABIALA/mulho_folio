                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
                    ...
                    <div className="hidden lg:block">
                        <div className="relative">
                            ...
                            <div
                                className="relative bg-zinc-900 rounded-2xl border border-amber-500/20 shadow-2xl shadow-amber-500/10 overflow-hidden cursor-pointer transition-all duration-300 group/terminal hover:border-amber-500/50 hover:shadow-amber-500/20"
                            ...
                            >
                                ...
                                {/* Hint terminal au survol */}
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/terminal:opacity-100 transition-opacity duration-300 pointer-events-none"

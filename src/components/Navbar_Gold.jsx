                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex items-center gap-3">
                        <a href="/" className="flex items-center gap-3 text-white no-underline group">
                            <div className="relative w-12 h-12 rounded-xl flex items-center justify-center shadow-xl shadow-amber-500/50 transform group-hover:rotate-12 transition-all duration-300 group-hover:scale-110 overflow-hidden">
